            ...
            <nav className="sticky top-0 z-50 w-full border-b border-border/60 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
                <div className="container mx-auto px-4">
                    <div className="flex h-16 items-center justify-between">
                        {/* Logo - reuses shared BrandLogo component (DRY) */}
                        <Link
                            href="/"
                        ...
                        <div className="hidden items-center gap-8 md:flex">
                            {navLinks.map((link) => (
                                <Link
                                    ...
                                    href={link.href}
                                    className={cn(
                                        'flex items-center gap-2 text-sm font-medium transition-colors hover:text-brand-blue-dark',
                            ...
                            {auth.user ? (
                                <DropdownMenu>
                                    <DropdownMenuTrigger asChild>
                                        <Button
                                            variant="ghost"
                                            className="gap-2 font-medium hover:text-brand-blue-dark"
                                        >
                        ...
                        <Button
                            variant="ghost"
                            size="icon"
                            className="hover:text-brand-blue-dark md:hidden"
                                            ...
                                            >
                                                ...
                                                <span
                                                    className={cn(
                                                        ...
                                                        isActive &&
                                                            'underline decoration-brand-blue-dark decoration-2 underline-offset-8',
                                                    )}
                                                >
                                                    {link.label}
                                                </span>
                                ...
                                {auth.user ? (
                                    <>
                                        ...
                                        <div className="flex gap-6">
                                            ...
                                            <Link
                                                ...
                                                method="post"
                                                as="button"
                                                className=":bg-red-950 flex h-10 w-10 items-center justify-center rounded-full border border-red-200 bg-background text-red-600 transition-colors hover:bg-red-50 hover:text-red-700"
                                                onClick={() =>
                                                    setMobileMenuOpen(false)
                                                }
                                            >
                                    ...
                                    <div className="flex flex-col gap-4">
                                        <Button
                                            ...
                                            size="lg"
                                            asChild
                                            className="w-48 border-brand-blue-dark text-brand-blue-dark hover:bg-brand-blue-dark hover:text-white"
                                        >
                                            <Link href="/login">Login</Link>
                                        </Button>
                                        <Button
                                            size="lg"
                                            asChild
                                            className="w-48 bg-brand-blue-dark text-white hover:bg-brand-blue-dark/90"
                                        >
                                            <Link href="/register">
                                                Register
                                            </Link>
